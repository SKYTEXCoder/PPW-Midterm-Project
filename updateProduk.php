    ...
    <main class="main-content">
        <section class="activation-form-section">
            ...
            <form action="database/funcproduk.php" method="POST" class="activation-form" enctype="multipart/form-data">
                <input type="hidden" class="condition" id="condition" name="condition" value="update" autocorrect="off"
                    autocapitalize="off" autocomplete="off" required>
                <input type="hidden" class="idProdukUpdate" id="idProdukUpdate" name="idProdukUpdate"
                    value="<?php echo $idProdukValue; ?>" autocorrect="off" autocapitalize="off" autocomplete="off"
                    required>
                <label for="namaProdukUpdate">Nama Produk</label>
                <input type="text" id="namaProdukUpdate" name="namaProdukUpdate" autocorrect="off" autocapitalize="off"
                    autocomplete="off" required value="<?php echo $namaProduk ?>">
                <label for="deskripsiProdukUpdate">Deskripsi Produk</label>
                <input type="text" id="deskripsiProdukUpdate" name="deskripsiProdukUpdate" autocorrect="off"
                    autocapitalize="off" autocomplete="off" required value="<?php echo $deskripsiProdukCurrent ?>">
                <label for="hargaProdukUpdate">Harga Produk</label>
                <input type="text" id="hargaProdukUpdate" name="hargaProdukUpdate" autocorrect="off"
                    autocapitalize="off" autocomplete="off" required value="<?php echo $hargaProdukCurrent ?>">
                <label for="quantityProdukUpdate">Kuantitas Produk</label>
                <input type="text" id="quantityProdukUpdate" name="quantityProdukUpdate" autocorrect="off"
                    autocapitalize="off" autocomplete="off" required value="<?php echo $quantityProdukCurrent ?>">
