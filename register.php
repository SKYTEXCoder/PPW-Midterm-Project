    ...
    <div class="web-body" style="padding-top: 98px;">
        <div class="login-box" style="height: 470px; padding-top: 5px; padding-bottom: 35px;">
            ...
            <form action="register.php" class="login" method="POST">
                ...
                <input type="email" class="email" id="account_email_address" name="account_email_address" placeholder="Email Address" autocorrect="off" autocapitalize="off" autocomplete="off" required>
                <input type="text" class="nomorHP" id="account_phone_number" name="account_phone_number" placeholder="Nomor HP" autocorrect="off" autocapitalize="off" autocomplete="off" required>
                ...
                <input type="password" class="confirmPassword" id="account_password_confirm" name="account_password_confirm" placeholder="Konfirmasi Kata Sandi" autocorrect="off" autocapitalize="off" autocomplete="off" required>
